...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.task_descr'
        db.alter_column(u'manager_task', 'task_descr', self.gf('django.db.models.fields.CharField')(max_length=70))

    def backwards(self, orm):

        # Changing field 'Task.task_descr'
        db.alter_column(u'manager_task', 'task_descr', self.gf('django.db.models.fields.TextField')())
