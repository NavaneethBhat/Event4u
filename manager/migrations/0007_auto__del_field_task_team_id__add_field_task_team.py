...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Task.team_id'
        db.delete_column(u'manager_task', 'team_id_id')

        # Adding field 'Task.team'
        db.add_column(u'manager_task', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['manager.Team']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Task.team_id'
        db.add_column(u'manager_task', 'team_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['manager.Team']),
                      keep_default=False)

        # Deleting field 'Task.team'
        db.delete_column(u'manager_task', 'team_id')
