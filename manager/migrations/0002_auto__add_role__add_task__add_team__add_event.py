...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'manager_role', (
            ...
            ('event_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['manager.Event'])),
            ('team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['manager.Team'])),
        ...
        db.create_table(u'manager_task', (
            ...
            ('task_descr', self.gf('django.db.models.fields.TextField')()),
        ))
