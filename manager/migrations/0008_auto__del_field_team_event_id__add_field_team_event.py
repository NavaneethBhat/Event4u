...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Team.event_id'
        db.delete_column(u'manager_team', 'event_id_id')

        # Adding field 'Team.event'
        db.add_column(u'manager_team', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['manager.Event']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Team.event_id'
        db.add_column(u'manager_team', 'event_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['manager.Event']),
                      keep_default=False)

        # Deleting field 'Team.event'
        db.delete_column(u'manager_team', 'event_id')
